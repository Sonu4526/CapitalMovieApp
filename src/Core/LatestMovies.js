...
export default function LatestMovies(props) {
    ...
    useEffect(() => {
        axios.get(`http://api.themoviedb.org/3/discover/movie?certification_country=US&sort_by=vote_average.desc&api_key=3ea87e57bdb34c48392dbb966280e8ad`).then((response) => {
            ...
            >
                ...
                <div className={classes.hero}>
                    ...
                    <Typography variant={"body1"} align="center" className={classes.text}>
                        Sign in to access your Favourite List
